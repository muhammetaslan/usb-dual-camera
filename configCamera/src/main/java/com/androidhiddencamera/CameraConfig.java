...
public final class CameraConfig {
    ...
    public class Builder {
        ...
        public CameraConfig build(String path) {
            if (mImageFile == null) mImageFile = getDefaultStorageFile(path);
            return CameraConfig.this;
        }
        /**
        ...
        private File getDefaultStorageFile() {
            ...
            File file;
            File tempFile = new File(HiddenCameraUtils.getCacheDir(mContext).getAbsolutePath()
                    + File.separator
                    + "IMG_" + milis   //IMG_214515184113123.png
                    + (mImageFormat == CameraImageFormat.FORMAT_JPEG ? ".jpeg" : ".png")) ;

            if (tempFile.exists()){
                milis++;
                file = new File(HiddenCameraUtils.getCacheDir(mContext).getAbsolutePath()
                        + File.separator
                        + "IMG_" + milis   //IMG_214515184113123.png
                        + (mImageFormat == CameraImageFormat.FORMAT_JPEG ? ".jpeg" : ".png")) ;
            ...
            Log.d("Cameraconfigzz1",""+file.getPath());
            return file;
        }
        @NonNull
        private File getDefaultStorageFile(String path) {
